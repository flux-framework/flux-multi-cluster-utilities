...
2. Starts three 1-node target Flux instances on the remaining nodes.
3. Loads the delegate configuration (a list of target URIs) and the
   `delegate.so` plugin into the source instance.
